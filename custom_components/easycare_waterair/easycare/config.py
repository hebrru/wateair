...
class EasyCareConfig:
    ...
    def username(self) -> str:
        """The user login used for authentication."""
        return self._kw.get("username") if self._kw.get("username") is not None else UNSET

    @property
    def password(self) -> str:
        """The user password used for authentication."""
        return self._kw.get("password") if self._kw.get("password") is not None else UNSET
